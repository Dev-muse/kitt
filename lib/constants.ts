...
export const voiceOptions = {
  ...
  lamin: {
    id: "hILdTfuUq4LRBMrxHERr",
    name: "Lamin",
    description: "Middle-aged Black Male with a deep voice",
  },
...
export const voiceCategories = {
  male: ["dave", "daniel", "chris","lamin"],
  female: ["rachel", "sarah"],
};

// Default voice
export const DEFAULT_VOICE = "lamin";
